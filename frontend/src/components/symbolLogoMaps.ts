...
export const TRADINGVIEW_SYMBOL_SLUG_MAP: Record<string, string> = {
    ...
    AA: 'alcoa--big',
    AEM: 'agnico-eagle-mines--big',
    B: 'barrick-gold--big',
    EWZ: 'ishares--big',
    FCX: 'freeport-mcmoran--big',
    HUZ: 'global-x--big',
    OVV: 'ovintiv--big',
    SIVR: 'abrdn--big',
    SLV: 'ishares--big',
...
const EXPLICIT_SYMBOL_LOGO_URL_MAP: Record<string, string[]> = {
    AA: ['https://s3-symbol-logo.tradingview.com/alcoa--big.svg'],
    AEM: ['https://s3-symbol-logo.tradingview.com/agnico-eagle-mines--big.svg'],
    B: ['https://s3-symbol-logo.tradingview.com/barrick-gold--big.svg'],
    EBEBK: ['https://s3-symbol-logo.tradingview.com/ebebek-magazacilik--big.svg'],
    EWZ: ['https://s3-symbol-logo.tradingview.com/ishares--big.svg'],
    FCX: ['https://s3-symbol-logo.tradingview.com/freeport-mcmoran--big.svg'],
    GUNDG: ['https://s3-symbol-logo.tradingview.com/gundogdu-gida--big.svg'],
    HUZ: ['https://s3-symbol-logo.tradingview.com/global-x--big.svg'],
    OVV: ['https://s3-symbol-logo.tradingview.com/ovintiv--big.svg'],
    SIVR: ['https://s3-symbol-logo.tradingview.com/abrdn--big.svg'],
    SLV: ['https://s3-symbol-logo.tradingview.com/ishares--big.svg'],
    SQQQ: ['https://s3-symbol-logo.tradingview.com/proshares--big.svg'],
    SVUSA: ['https://s3-symbol-logo.tradingview.com/ubs-group--big.svg'],
    TRHOL: ['https://s3-symbol-logo.tradingview.com/dagi-yatirim-holding--big.svg'],
    XOM: ['https://s3-symbol-logo.tradingview.com/exxon--big.svg'],
    ZSIGEU: ['https://s3-symbol-logo.tradingview.com/swisscanto--big.svg'],
    TEHOL: [
...
const FUND_MANAGER_LOGO_SLUG_MAP: Record<string, string[]> = {
    ...
    phillip_portfoy: ['phillip_portfoy_icon'],
