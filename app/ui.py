...
def _render_kap_financials_page() -> None:
    ...
    companies = _available_companies()
    # KAP sekmesi icin, rapor yuklenmemis olsa da secilebilecek genis bir sembol listesi sun.
    # Tekilleştirme goruntu etiketine gore yapilir (orn. BIM + BIMAS => tek BIM).
    merged_candidates: List[str] = list(companies) + list(KAP_DEFAULT_SYMBOL_CANDIDATES)
